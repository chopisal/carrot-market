      ...
      <div className="mt-8 ">
        <div className="flex flex-col items-center">
          ...
          <div className="grid border-b w-full mt-8 grid-cols-2">
            ...
            <button
              className={cls(
                "pb4 font-medium text-sm border-b-2",
                method === "phone"
                  ? "border-orange-500 text-orange-400"
                  : "border-transparent hover:text-gray-400 text-gray-500"
              )}
          ...
          <div className="mt-1">
            ...
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                ...
                <input
                  type="number"
                  className="w-full py-2 px-4 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 rounded-l-none"
                  required
                />
              </div>
            ) : null}
          </div>
          <button className=" mt-5 bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium ">
